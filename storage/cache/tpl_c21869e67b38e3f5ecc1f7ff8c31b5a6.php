            ...
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-white lead">Your tickets for <strong class="text-white fw-bold"><?php echo $event->event_title; ?></strong> have been confirmed.</p>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <span class="font-monospace text-white fw-bold"><?php echo $transaction->reference_id; ?></span>
                                        </div>
                                        <div class="col-sm-6">
                                            <strong class="text-white">Amount Paid:</strong><br>
                                            <span class="text-white fs-5">₦<?php echo number_format($transaction->amount, 2); ?></span>
                                        </div>
                                        <div class="col-12 mt-2">
                                            <strong class="text-white">Email:</strong>
                                            <span class="text-white ps-2 fw-bold"><?php echo $transaction->email; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="mb-0 text-white">
                                        ...
                                        Your Tickets (<?php echo count($attendees); ?>)
                                    </h6>
                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <span class="text-capitalize fw-medium"><?php echo $attendee->name; ?></span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <small class="text-muted"><?php echo $attendee->email; ?></small>
                                                        </td>
                                                        <td>
                                                            <code class="bg-light px-2 py-1 rounded"><?php echo $attendee->ticket_code; ?></code>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button"
                                                                ...
                                                                data-bs-target="#ticketModal<?php echo $index; ?>">
                    ...
                    <div class="text-center mt-4">
                        <div class="row justify-content-center">
                            <div class="col-12 mb-3">
                                <a href="/checkout/download-all-tickets/<?php echo $transaction->reference_id; ?>"
...
<!-- Ticket Modals -->
<?php foreach ($attendees as $index => $attendee): ?>
    <div class="modal fade" id="ticketModal<?php echo $index; ?>" tabindex="-1" aria-labelledby="ticketModalLabel<?php echo $index; ?>" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="ticketModalLabel<?php echo $index; ?>">
                        <i class="bi bi-ticket-perforated me-2"></i>
                        Event Ticket - <?php echo $attendee->name; ?>
                    </h5>
                ...
                <div class="modal-body">
                    <div class="ticket-preview border rounded p-4" style="background: linear-gradient(135deg, #1e88e5 0%, #0d47a1 100%); color: white;">
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-8">
                                <h4 class="mb-1"><?php echo $event->event_title; ?></h4>
                                <p class="mb-0 opacity-75">
                                    <i class="bi bi-calendar3 me-2"></i>
                                    <?php echo date('M d, Y • g:i A', strtotime($event->start_date . ' ' . $event->start_time)); ?>
                                </p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="fw-bold"><?php echo $attendee->name; ?></div>
                                </div>
                                <div class="mb-3">
                                    <small class="text-uppercase opacity-75">Email</small>
                                    <div><?php echo $attendee->email; ?></div>
                                </div>
                                <div class="mb-3">
                                    <small class="text-uppercase opacity-75">Ticket Code</small>
                                    <div class="font-monospace fw-bold"><?php echo $attendee->ticket_code; ?></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div>
                                        ...
                                        <?php echo $event->venue ?? 'Venue TBA'; ?>
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="font-monospace small"><?php echo $transaction->reference_id; ?></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <p class="card-text text-white mb-0">
                                        <?php echo substr($event->description, 0, 200); ?><?php echo strlen($event->description) > 150 ? '...' : ''; ?>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <a href="/checkout/download-ticket/<?php echo $attendee->id; ?>/<?php echo $transaction->reference_id; ?>"
