                ...
                <div class="col-md-8">
                    <div class="event-header mb-3">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            ...
                            <span class="badge <?php echo $this->escape($event->status == 'active' ? 'bg-success' : 'bg-secondary'); ?> text-capitalize">
                                <i class="bi bi-<?php echo $this->escape($event->status == 'active' ? 'check-circle' : 'x-circle'); ?> me-1"></i>
                                <?php echo $event->status == 'active' ? 'Active' : 'Disabled'; ?>
                            </span>
                        </div>
                            ...
                            <?php if (isset($recentAttendees) && !empty($recentAttendees)): ?>
                                <?php foreach ($recentAttendees as $k => $attendee): ?>
                                    <tr class="fade-in" style="animation-delay: <?= $k * 0.1 ?>s;">
                                        ...
                                        <td data-label="Ticket Type">
                                            <span class="ticket-type-badge"><?php echo $attendee->ticket_name ?? 'Unknown'; ?></span>
                                        </td>
                                        ...
                                        <td data-label="Status">
                                            <div class="text-center">
                                                ...
                                                <span class="badge <?= $statusClass ?>">
                                                    ...
                                                    <?php echo ucfirst($attendee->status ?? 'Unknown'); ?>
                                                </span>
                                            </div>
                                        </td>
                                        <td data-label="Amount">
                                            <div class="text-center">
                                                <div class="fw-semibold text-white">₦<?php echo number_format($attendee->amount ?? 0); ?></div>
                                            </div>
                                        </td>
            ...
            <div class="card-body">
                ...
                <div class="setting-item mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge <?php echo $this->escape($event->status == 'active' ? 'bg-success' : 'bg-secondary'); ?>">
        ...
        <div class="dashboard-card">
            <div class="d-flex justify-content-center gap-3 flex-wrap">
                ...
                <?php if ($event->ticket_sales === 'close'): ?>
                    <form action="<?php echo $this->escape(url("/admin/events/ticket-status")); ?>" method="post" onsubmit="return confirm('Are you sure you want to update ticket sales?');">
                ...
                <?php if ($event->status === 'disable'): ?>
                    <form action="<?php echo $this->escape(url("/admin/events/status")); ?>" method="post" onsubmit="return confirm('Are you sure you want to update event status?');">
                        <input type="hidden" name="event_slug" value="<?= $event->slug ?>">
