...
<section id="events" class="py-5">
    <div class="container">
            ...
            <?php foreach ($events as $event): ?>
                ...
                <div class="col-12 col-md-6 col-xl-4 reveal">
                    <article class="event-card h-100 d-flex flex-column">
                        <img class="event-img" src="{{{ get_image($event->event_image) }}}" alt="{{{ $event->event_title }}}">
                        <div class="p-3 p-md-4">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="text-info-emphasis small"><i class="bi bi-calendar-event"></i> {{ date('D • M j', strtotime($event->event_date)) }}</span>
                            </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-2">
                                ...
                                <a href="{{ url("/events/$event->id/{$event->slug}") }}" class="btn btn-pulse btn-sm"><i class="bi bi-ticket-perforated me-1"></i> Get Tickets</a>
                            </div>
                        </div>
                    </article>
                </div>
        ...
        <div class="text-center mt-4 reveal delay-3">
            <a href="{{ url("/events") }}" class="btn btn-ghost"><i class="bi bi-collection-play me-2"></i>View all events</a>
        </div>
    </div>
</section>
            ...
            <?php foreach ($categories as $category): ?>
                ...
                <div class="col-12 col-md-6 col-xl-3 reveal">
                    <div class="category-card h-100">
                        ...
                        <a href="{{{ url("/events?category=$category->id") }}}" class="btn btn-ghost w-100 mt-2">Explore</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center g-4">
            ...
            <div class="col-lg-6 reveal delay-1">
                ...
                <a href="{{{ url('/events') }}}" class="btn btn-ghost mt-3">Start now</a>
            </div>
        </div>
    </div>
</section>
