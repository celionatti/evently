    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-3">
                <li class="nav-item"><a class="nav-link <?= active_nav(1, 'events') ? 'active' : '' ?>" href="<?= url("/events") ?>">Discover Events</a></li>
                <li class="nav-item"><a class="nav-link <?= active_nav(1, 'articles') ? 'active' : '' ?>" href="<?= url("/articles") ?>">Articles</a></li>
                <li class="nav-item"><a class="nav-link <?= active_nav(1, 'about-us') ? 'active' : '' ?>" href="<?= url("/about-us") ?>">About Us</a></li>
...
<div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="mobileNav" aria-labelledby="mobileNavLabel" style="background:rgba(6,10,20,.98)">
    ...
    <div class="offcanvas-body">
        <a class="nav-link <?= active_nav(1, 'events') ? 'active' : '' ?> py-2" href="<?= url("/events") ?>">Discover Events</a>
        <a class="nav-link <?= active_nav(1, 'articles') ? 'active' : '' ?> py-2" href="<?= url("/articles") ?>">Articles</a>
