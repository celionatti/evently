...
<div id="create-advertisement-section" class="content-section fade-in">
    <div class="d-flex justify-content-between align-items-center mb-4 gap-3 page-header">
        <div>
            ...
            <p class="text-secondary">Update {{{ $advertisement->title }}} advertisement campaign.</p>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div id="url_upload_section" class="upload-section" style="display: none;">
                                    <input type="url" class="form-control {{{ has_error('image_url') ? 'is-invalid' : '' }}}" id="image_url" name="image_url" value="{{{ old('image_url', $advertisement->image_url) }}}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="datetime-local" class="form-control {{{ has_error('start_date') ? 'is-invalid' : '' }}}" id="start_date" name="start_date" value="{{{ old('start_date', $advertisement->start_date) }}}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="datetime-local" class="form-control {{{ has_error('end_date') ? 'is-invalid' : '' }}}" id="end_date" name="end_date" value="{{{ old('end_date', $advertisement->end_date) }}}" required>
