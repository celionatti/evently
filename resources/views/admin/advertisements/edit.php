                    ...
                    <form id="createAdvertisementForm" action="" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title" value="{{{ old('title', $advertisement->title) }}}" required maxlength="255"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div id="url_upload_section" class="upload-section" style="display: none;">
                                    <input type="url" class="form-control" id="image_url" name="image_url" value="{{{ old('image_url', $advertisement->image_url) }}}"
